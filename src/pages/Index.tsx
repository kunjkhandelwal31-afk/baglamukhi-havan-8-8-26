          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: "आप हमारी वेबसाइट पर ऑनलाइन बुकिंग फ़ॉर्म भरकर या +91 81039 60297 पर कॉल / WhatsApp करके हवन बुक कर सकते हैं। भारत एवं विश्व के किसी भी स्थान से booking उपलब्ध है। 24 घंटे में हमारी टीम संपर्क करेगी।",
              },
              {
        ...
        <div className="container mx-auto px-4 max-w-3xl text-white/85 leading-relaxed text-sm md:text-base space-y-10">
            ...
            <article className="space-y-4">
              ...
              <p>
                ...
                <Link to="/contact" className="underline" style={{ color: '#FFD700' }}>संपर्क पेज</Link> से जुड़ें। +91 81039 60297 पर कॉल या
              ...
              <p>
                ...
                WhatsApp +91 81039 60297 — our team will respond within 24 hours.
              </p>
