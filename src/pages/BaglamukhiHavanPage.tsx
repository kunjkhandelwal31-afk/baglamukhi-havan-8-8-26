        ...
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <ul className="space-y-2 mb-6">
            {[
              ...
              "पारदर्शी pricing — ₹5,100 से प्रारंभ, कोई छुपा शुल्क नहीं",
          ...
          <div className="space-y-4 mb-8">
            {[
              ...
              { q: "Baglamukhi Havan की cost कितनी है?", a: "सामान्य हवन ₹5,100 से, लाल मिर्च हवन ₹11,000 से, 36,000 मंत्र अनुष्ठान ₹31,000 से प्रारंभ। पारदर्शी pricing — कोई छुपा शुल्क नहीं।" },
